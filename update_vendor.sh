...
sudo setfattr -h -n security.selinux -v "u:object_r:vendor_file:s0" lib64/libgallium_dri.so
sudo setfattr -h -n security.selinux -v "u:object_r:vendor_file:s0" lib64/libglapi.so
sudo setfattr -h -n security.selinux -v "u:object_r:vendor_file:s0" lib64/hw/vulkan.freedreno.so
sudo setfattr -h -n security.selinux -v "u:object_r:vendor_file:s0" lib64/egl
sudo setfattr -h -n security.selinux -v "u:object_r:vendor_file:s0" lib64/egl/libGLESv1_CM_mesa.so
sudo setfattr -h -n security.selinux -v "u:object_r:vendor_file:s0" lib64/egl/libGLESv2_mesa.so
sudo setfattr -h -n security.selinux -v "u:object_r:vendor_file:s0" lib64/egl/libEGL_mesa.so
